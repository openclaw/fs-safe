...
fallback profile, measured distribution hash, and planned C/B distribution
identity. A candidate-equivalent distribution must report the sanitized profile.
Rows marked `changed-output`
