...
export const sections = [
  ...
  ["Specialized", ["copy.md", "guest.md", "secret-file.md", "secure-file.md", "permissions.md", "regular-file.md", "positional-read.md", "sidecar-lock.md", "local-roots.md"]],
  ["Path & filename", ["path.md", "filename.md", "install-path.md", "directory-identity.md"]],
