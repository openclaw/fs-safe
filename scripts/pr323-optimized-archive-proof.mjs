...
const BASELINE = "4b1afa00d6aee35753b5c25cc8555e3329657d34";
const CANDIDATE = "eb6e155153c45b3ba41c1d45e60dd3697aa663dd";
const PLAN_SHA256 = "331f0f2a7e12ef126a32814139bebfdfb426dbcd06f717d704236f4b0f205668";
...
function validatePlan(planPath, mode) {
  ...
  assert.equal(plan.experiment, "archive-final");
...
async function childMain(encoded) {
  ...
  try {
    ...
    receipt.fixtureManifestSha256 = fileSha256(path.join(config.fixtureDir, "manifest.json"));
