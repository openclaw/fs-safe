...
`ESTALE`. Directory cleanup admits an exact bigint device/inode receipt before
removing children, then rechecks that receipt and directory type immediately
before the mutation-authority check and removal. Unknown Windows identity
