  ...
  const rollback = (
    ...
    try {
      renameRetainedDirectory({
        ...
        renameNoReplace: () => {
          retained.renameNoReplace("target", backupBasename, targetBasename);
        },
        onIndeterminate() {
  ...
  try {
    if (targetIdentity) {
      try {
        backup.identity = renameRetainedDirectory({
          ...
          renameNoReplace: () => {
            retained.renameNoReplace("target", targetBasename, backupBasename);
          },
          onIndeterminate() {
            backup.transition = "indeterminate";
          },
    ...
    try {
      renameRetainedDirectory({
        ...
        renameNoReplace: () => {
          retained.renameNoReplace("staged", stagedBasename, targetBasename);
        },
        onIndeterminate() {
