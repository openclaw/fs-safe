  ...
  it.runIf(Boolean(directoryReplacementNative))(
    ...
    async () => {
      ...
      const renameNoReplaceWithIdentity = vi.fn(
        directoryReplacementNative!.renameNoReplaceWithIdentity!.bind(
      ...
      try {
        ...
        expect(mkdir).toHaveBeenCalledTimes(1);
        expect(renameNoReplaceWithIdentity).toHaveBeenCalledTimes(2);
      } finally {
        releaseFirstCleanup();
      }
      ...
      expect(renameNoReplaceWithIdentity).toHaveBeenCalledTimes(4);
