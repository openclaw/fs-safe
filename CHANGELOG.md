...
- Verify `Root.openWritable()` descriptor, pathname, canonical target, and failed-create cleanup identities with lossless bigint receipts, rejecting rounded aliases and persistently unknown Windows identities before truncation, handle return, or cleanup.
