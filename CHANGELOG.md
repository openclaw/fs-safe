...
- Add `follow-parents-within-root` reads and opt-in `mutationSymlinks` policies, following contained directory aliases while rejecting final symlinks at open and publication boundaries.
