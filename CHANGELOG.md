...
- Reject invalid or Node-overflowing lock compromise-check intervals before acquisition, preventing oversized delays from becoming millisecond filesystem polling loops.
