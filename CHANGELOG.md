...
- Escape control characters in archive-entry and root-path diagnostics, and reject NUL inputs in the direct sync and async root resolvers before Node can echo raw attacker-controlled paths from a syscall error.
