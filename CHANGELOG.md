...
- Bind npm publication to the protected `npm-publish` GitHub environment and require environment-bound trusted publishers for all eight release packages, with reviewed tag-only deployment policy and no unbound publishing alternative.
