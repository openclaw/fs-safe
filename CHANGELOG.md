...
- Bind `Root.open()` and Root reads to the originally captured root directory with a best-effort final root/file/root observation fence, including fresh canonical containment and exact descriptor identity, and close the descriptor before rejection.
