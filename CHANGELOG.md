...
- Avoid duplicate filesystem lookups in Windows compatibility lock resolution and Root publication verification; reuse resolver metadata only within each verification pass, retaining fresh final pathname, descriptor, parent, and root checks.
