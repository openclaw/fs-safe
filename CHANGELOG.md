...
- Reduce repeated ZIP filename decoding and validation when local and central names and Unicode metadata are identical, while retaining independent checks for differing names, CRCs, and interpretations.
