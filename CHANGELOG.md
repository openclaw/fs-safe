...
- Address Windows fallback and ACL reporting commands by their built-in module names and keep module discovery within PowerShell's bundled system modules to avoid broad command discovery scans on cold starts.
