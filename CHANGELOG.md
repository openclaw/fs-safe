...
- Simplify internals without changing public behavior: remove unused string/home helpers, `resolveUserPath`, `createBoundedReadStream`, `sidecarLockPayloadIsStale`, and `tarManifestEntryCost`; share filesystem utilities, atomic temp ownership state, walker accounting, regular-file validation, root write contracts, and cleanup error shaping; merge private modules.
