...
- Claim durable queue generations before reading so acknowledgement and quarantine cannot delete or move a newer same-ID replacement, and preserve existing failed-entry evidence on collisions.
